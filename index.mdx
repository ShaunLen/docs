...
title: "Home"
icon: "home"
description: "Welcome to the Northbound wiki!"
---

## What's this for?

This wiki exists to make the process of understanding and using the shared libraries of Northbound much easier (hopefully).
All of our libraries are designed to be powerful and robust on the inside, yet simple and flexible on the outside.

## Getting started

A collection of guides are accessible in the left navigation, and API references can be accessed via the top navigation.
