...
<Tip>
Namespaces **must** match folder structure exactly. See the [Folder Structure](/handbook/folder-structure) page for comprehensive project organization guidelines.
</Tip>
